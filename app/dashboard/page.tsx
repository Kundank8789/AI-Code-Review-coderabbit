    ...
    <div className='space-y-6'>
      ...
      <div className='grid gap-4 md:grid-cols-4'>
        ...
        <Card>
          ...
          <CardContent>
            <div className='text-2xl font-bold'>{isLoading ? "..." : stats?.totalReview || 0}</div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Commits and Pull Requests over the last 12 months</CardDescription>
        </CardHeader>
        <CardContent>
          <ContributionGraph/>
        </CardContent>
